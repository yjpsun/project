...
@Table(name = "sales")
@NamedQueries({
	@NamedQuery(name = "getSaleSum", query="select sum(o.purQ) from Sales o where o.material.id = ? and o.demDate >= ? and o.demDate< ?"),
	@NamedQuery(name = "getSaleSum2", query="select sum(o.purQ) from Sales o where o.material.id = ? and o.demDate >= ?")
})
public class Sales extends IdEntity{
