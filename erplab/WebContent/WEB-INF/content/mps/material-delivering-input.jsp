		...
		<fieldset>
			...
			<form action="${ctx}/mps/material!save.do" method="post" id="materialForm">
				...
				<div class="item_line">
					...
					<div class="item_input"><input type="text" name="material.matPs" value="${material.matPs}"></div>
					<div class="item_label"><s:text name="material.label.lsr"/></div>
					<div class="item_input"><input type="text" name="material.matLsr" value="${material.matLsr}"></div>
				</div>
				<div class="item_line">
				...
				<div class="item_line">
					...
					<div class="item_input"><input type="text" name="material.sourceOrigin" value="${material.sourceOrigin}"></div>
